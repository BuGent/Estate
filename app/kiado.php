...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="menu">				
			...
			<a class="current_page_item" href="kiado.php">Kiadó ingatlanok</a>						
		...
		<div class="szures">
			<form id="kiadForm">
				...
				<input type="number" id="minimum" min="0" placeholder="ezer Ft" max="9999">
				<label for="maximum">Max. ár: </label>
				<input type="number" id="maximum" min="0" placeholder="ezer Ft" max="9999">
				<button type="submit" id="kiadbtn">Szűrés</button>
			</form>
		</div>

		<div id="kiadoEstates" class="estates"></div>
		<div id="more"></div>					
		...
		<script src="./public/kiado.js"></script>
